...
namespace Task_4_Pilynom
{
    class Polynomial
    {
        ...
        public static Polynomial operator +(Polynomial a, Polynomial b)
        {
            ...
            return result.PolunomAddition(a, b);
        ...
        public static Polynomial operator -(Polynomial a, Polynomial b)
        {
            ...
            return result.PolynomSubstraction(a, b);
        ...
        public static Polynomial operator *(Polynomial a, Polynomial b)
        {
            ...
            return result.PolynomMultiplication(a, b);
        ...
        public static implicit operator Polynomial(double value)
        {
            if (value <= 0)
            {
                throw new ArgumentException("Index cannot be out of range", nameof(value));
            }
